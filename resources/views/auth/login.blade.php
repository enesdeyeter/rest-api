...
<form class="form fv-plugins-bootstrap fv-plugins-framework" novalidate="novalidate" id="kt_login_signin_form" method="post" action="{{route('login-post')}}">
@csrf
<!--begin::Title-->
    <div class="pb-13 pt-lg-0 pt-5">
        <span class="text-muted font-weight-bold font-size-h2">soci login page</span><br><br>
